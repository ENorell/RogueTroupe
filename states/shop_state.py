...
from components.character import (
    Character, Tankylosaurus, Macedon, Healamimus, Dilophmageras,
    Tripiketops, Velocirougue, Archeryptrx, Alchemixus, Bardomimus,
    Battlemagodon, Naturalis, Necrorex, Quetza, Krytoraptor, Triceros
)
...
from settings import Vector, Color, DISPLAY_WIDTH, DISPLAY_HEIGHT, DEFAULT_TEXT_SIZE, BLACK_COLOR, RED_COLOR

# Constants
SHOP_POOL: list[type[Character]] = [
    Tankylosaurus, Macedon, Healamimus, Dilophmageras, Tripiketops,
    Velocirougue, Archeryptrx, Alchemixus, Bardomimus, Battlemagodon,
    Naturalis, Necrorex, Quetza, Krytoraptor, Triceros
]
...
gold_icon_image = transform.scale(IMAGES[ImageChoice.GOLD_ICON], (GOLD_ICON_SIZE, GOLD_ICON_SIZE))

GOLD_BACK_WIDTH = 80
GOLD_BACK_HEIGHT = 56
GOLD_BACK_POSITION = (GOLD_ICON_POSITION[0]+60, GOLD_ICON_POSITION[1]+16)
gold_back_image = transform.scale(IMAGES[ImageChoice.GOLD_BACK], (GOLD_BACK_WIDTH, GOLD_BACK_HEIGHT))
