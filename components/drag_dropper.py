...
def draw_drag_dropper(frame: Surface, drag_dropper: DragDropper) -> None:
    ...
    for slot in drag_dropper.slots:
        ...
        draw_character(frame, position, slot.content, scale_ratio=scale_ratio, slot_is_hovered=slot.is_hovered)
    ...
    if hovered_slot:
        ...
        draw_character(frame, position, hovered_slot.content, scale_ratio=DEFAULT_HOVER_SCALE_RATIO, slot_is_hovered=True)
